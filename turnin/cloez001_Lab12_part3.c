...
int Demo_Tick(int state) {
    ...
    // Local Variables
    static unsigned char pattern = 0x24;	//0x80;	// LED pattern - 0: LED off; 1: LED on
    static unsigned char row = 0x11;  	// Row(s) displaying pattern. 
...
void Hello(){ 
    ...
    switch(Hello_State){
	case Hello_1:
	    PORTD = 0x15; PORTC = 0x24;
	    break;
	case Hello_2:
            PORTD = 0x11; PORTC = 0x24;
            break;
	case Hello_3:
            PORTD = 0x15; PORTC = 0x3C;
            break;
